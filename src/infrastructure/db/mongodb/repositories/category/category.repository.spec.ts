...
describe('MongoDB Item Repository tests', () => {
    it('should create a category', async () => {
        ...
        const categoryCreated = await CategoryModel.findOne({_id: category.id});
    ...
    it('should update a category', async () => {
        ...
        const updateCategory = new Category('any_hash_id', 'Category 2', 'Description 2');
        await sut.update(updateCategory);
        const categoryUpdated = await CategoryModel.findOne({_id: oldCategory.id});
