...
describe('User entity tests', () => {
    it('should throw if id is empty', () => {
        expect(() => {
            const sut = new User('', 'any_name', 'any_email@mail.com', 'any_password');
        }).toThrowError(new EntityError('user: Id is required, ')); 
    })

    it('should throw if name is empty', () => {
        expect(() => {
            const sut = new User('any_id', '', 'any_email@mail.com', 'any_password');
    ...
    it('should throw if email is invalid', () => {
        expect(() => {
            const sut = new User('any_id', 'any_name', 'any_email_invalid.invalid', 'any_password');
