...
describe('Bill entity unit tests', () => {
    ...
    it('should change name', () => {
        const bill = new Bill('1', 'Bill 1', [makeBillItem()]);
    ...
    it('should change description', () => {
        const bill = new Bill('1', 'Bill 1', [makeBillItem()], 'Description');
    ...
    it('should calculate total correctly', () => {
        const bill1 = new Bill('1', 'Bill 1', [makeBillItem(), makeBillItem()], 'Description');
        expect(bill1.total).toBe(400);
        const bill2 = new Bill('1', 'Bill 1', [makeBillItem()], 'Description');
